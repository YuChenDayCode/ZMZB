...
$.fn.KinSlideshow = function(settings){
	  settings = jQuery.extend({
		   ...
		   titleBar:{titleBar_height:30,titleBar_bgColor:"#000000",titleBar_alpha:0.5},//标题背景样式，(isHasTitleBar = true 前提下启用)
	 ...
	 function KinSlideshow_setTitleBar(){
		...
		$(KinSlideshow_BoxObject).append("<div class='KinSlideshow_titleBar' style='text-align:left'></div>");
	 ...
	 function KinSlideshow_setTitleFont(){
		 if(settings.isHasTitleFont){
			$(KinSlideshow_BoxObjectSelector+" .KinSlideshow_titleBar").append("<h2 class='title' style='margin:3px 0 0 6px;padding:0;height:25px;line-height:25px;'></h2>");	
